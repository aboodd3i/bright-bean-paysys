...
class SocialProvider(ABC):
    ...
    # ------------------------------------------------------------------
# Post discovery (optional - override per provider)
    # ------------------------------------------------------------------

    def get_recent_posts(self, access_token: str, limit: int = 25) -> list[dict]:
        """Fetch recent posts from the platform's feed.
        ...
        Returns a list of dicts with keys:
            ...
            - permalink: str
            - media_type: str ("" if unknown)
        """
        raise NotImplementedError(f"{self.platform_name} does not support post discovery")
